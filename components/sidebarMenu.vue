<template>
	<svg width="32px"height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
		<path
			...
			stroke-width="1.5"
		/>
		<path d="M5.5 10H11.5" stroke="#f4f4f5" stroke-width="1.5" stroke-linecap="round" />
		<path d="M6.5 14H10.5" stroke="#f4f4f5" stroke-width="1.5" stroke-linecap="round" />
		<path opacity="0.5" d="M15 21L15 3" stroke="#f4f4f5" stroke-width="1.5" stroke-linecap="round" />
	</svg>
</template>
